...
namespace TimeCalc
{
    public class dgvVertScroll : DataGridView
    {
        ...
        protected override void OnRowPostPaint(DataGridViewRowPostPaintEventArgs e)
        {
            ...
            if (this.RowHeadersWidth < (int)(Sz.Width + 20)) { this.RowHeadersWidth = (int)(Sz.Width + 20); }
            ...
            using (SolidBrush sBrush = new SolidBrush(RowHeadersDefaultCellStyle.ForeColor))
